...
atm_file = 'atm/atm_GasDwarf.txt' # TP and Kzz (optional) file
...
Rp = 1.6647e9 # Planetary radius (cm) (for computing gravity)
...
Tiso = 800.0 # only read when atm_type = 'isothermal'
